...
export class Config {
   ...
   */
  private async setContextValue(context: string, key: string, value: string | number | boolean): Promise<void> {
   ...
   */
  private flattenConfig(config: ConfigData, result: Record<string, string | number | boolean>, prefix: string): void {
